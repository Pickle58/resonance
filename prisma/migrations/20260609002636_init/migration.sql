...
-- CreateEnum
CREATE TYPE "VoiceCategory" AS ENUM ('GENERAL', 'AUDIOBOOK', 'CONVERSATIONAL', 'CUSTOMER_SERVICE', 'NARRATIVE', 'CHARACTERS', 'MEDITATION', 'MOTIVATIONAL', 'PODCAST', 'ADVERTISING', 'VOICEOVER', 'CORPORATE');
