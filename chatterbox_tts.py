...
#   --voice-key "voices/system/< voice key>"

# Use this to test CURL:
# curl -X POST "<your-modal-endpoint>/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: super-secret-key" \
#   -d '{"prompt": "Hello from Chatterbox [chuckle].", "voice_key": "voices/system/< voice key>"}' \
#   --output output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "resonance-app"
R2_ACCOUNT_ID = "3a3c9211676d25b5219c9693aa56574d"
R2_MOUNT_PATH = "/r2"
