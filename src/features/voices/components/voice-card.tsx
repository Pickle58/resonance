...
export function VoiceCard({ voice }: VoiceCardProps) {
    ...
    return (
        <div className="flex items-center gap-1 overflow-hidden rounded-xl border p-3 lg:pr-6">
            <div className="relative h-24 w-20 shrink-0 lg:h-30 lg:w-24">
                <div className="absolute left-0 top-0 he-24 w-10 border-r bg-muted/50 lg:h-30 lg:w-12" />
            ...
            <div className="flex min-w-0 flex-1 flex-col gap-1.5 lg:gap-3">
                <div className="flex items-center gap-1.5 line-clamp-1 test-sm font-medium tracking-tight">
                    {voice.name}
